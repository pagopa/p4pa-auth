...
class HashAlgorithmTest {
  ...
  private HashAlgorithm hashAlgorithm = new HashAlgorithm("SHA-256", Base64.getUrlDecoder().decode("PEPPER"));
  ...
  void givenInvalidAlgorithmWhenHashThenNoSuchAlgorithmException() {
    //Given
    hashAlgorithm = new HashAlgorithm("invalidAlgorithm", Base64.getUrlDecoder().decode("PEPPER"));
    //Then

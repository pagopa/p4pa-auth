...
class IDTokenClaims2UserInfoMapperTest {
    ...
    @Test
    void givenIDTokenNoOrganizationThenInvalidTokenException() {
        // Given
    ...
    @Test
    void givenIDTokenNoOrganizationRolesThenInvalidTokenException() {
        // Given

...
| JWT_REFRESH_TOKEN_EXPIRATION_SECONDS   | Refresh token expiration (seconds)                                                                                                                                                                                                                                      | 86400                |
| JWT_REFRESH_TOKEN_MAX_LIFETIME_SECONDS | Refresh token max session expiration (seconds)                                                                                                                                                                                                                          | 86400                |
